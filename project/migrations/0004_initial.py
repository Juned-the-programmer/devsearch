...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('project', '0003_remove_review_project_delete_project_delete_review_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_image', models.ImageField(blank=True, null=True, upload_to='static/project_image')),
